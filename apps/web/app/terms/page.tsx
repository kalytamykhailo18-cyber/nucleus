...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Cliente: la persona física consumidora que contrata y paga el servicio.Usuario: la persona que porta, utiliza o respecto de la cual opera el dispositivo o el servicio, pudiendo coincidir o no con el Cliente.Dispositivo: el equipo físico comercializado por Sensu como parte de la solución contratada.Aplicación o App: la aplicación móvil o sistema digital vinculado al servicio.Call Center: el centro de atención, monitoreo, seguimiento, contacto y gestión operado por o para Sensu.Servicios de Sensu: los servicios tecnológicos, de monitoreo, alertamiento, geolocalización, comunicación, recepción de eventos, gestión y canalización prestados por Sensu.Servicios de Terceros: asistencias, ambulancias, servicios médicos, aseguradores, viales, de hogar, funerarios o cualesquiera otros prestados por proveedores distintos de Sensu.Contacto de Emergencia: la persona designada por el Cliente o Usuario para ser contactada en caso de evento, alarma o incidente.Evento: toda alerta, señal, activación SOS, notificación de caída, salida de geocerca, batería baja, solicitud de asistencia, incidencia técnica o cualquier otro suceso detectado o reportado por el sistema.Geolocalización: datos de ubicación aproximada o en tiempo real obtenidos a través del dispositivo, la aplicación, redes móviles, GPS u otras tecnologías.Plan: el paquete anual contratado por el Cliente.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      'Para contratar el servicio, el Cliente deberá seleccionar uno de los planes disponibles de Sensu, ya sea (a) directamente a través del sitio web oficial de Sensu (www.sensu.com.mx) o de la plataforma Sensu, o (b) mediante un plan ofrecido y contratado a través de un distribuidor o vendedor autorizado de Sensu. Independientemente del canal a través del cual haya sido ofrecido o contratado, el plan seleccionado y sus componentes, alcances y condiciones económicas se sujetarán en todo momento a lo establecido en estos Términos y Condiciones.',
      ...
      'h) aviso a contactos de emergencia;i) enlace, canalización o gestión con proveedores terceros de servicios complementarios.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'h) fallas eléctricas o de telecomunicaciones;i) saturación de servicios externos;j) compatibilidad técnica.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'h) geolocalización en tiempo real;i) información médica relevante solo cuando el Cliente o Usuario la proporcione expresamente.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'h) problemas del fabricante;i) defectos de terceros;j) caso fortuito o fuerza mayor.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'h) mantener disponibilidad básica del equipo y medios asociados;i) asumir que el servicio es de apoyo y no un sustituto de atención personal o médica.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'h) tiempos exactos de atención o llegada de terceros;i) resultado específico ante una emergencia o incidente.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'h) falsas alarmas;i) indisponibilidad temporal del sistema;j) errores u omisiones en información proporcionada por el Cliente;k) imposibilidad de contactar al Usuario o a sus contactos;l) actos u omisiones de terceros;m) tiempos de respuesta de ambulancias, médicos, autoridades, aseguradoras o cualquier prestador externo;n) decisiones tomadas por el Usuario, sus familiares, cuidadores o terceros;o) uso indebido o incorrecto del dispositivo;p) cancelación, expiración o falta de renovación del plan;q) caso fortuito o fuerza mayor.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'h) acepta la vigencia anual, la ausencia de renovación forzosa, la política de cancelación y no reembolso posterior al primer mes, la garantía de precio en renovación y el proceso de baja previstos en estos Términos, salvo disposición legal imperativa;i) acepta las limitaciones y exclusiones de responsabilidad aquí previstas en la máxima medida permitida por la ley.',
    ],
  },
  {
    title: '40. Garantía legal del dispositivo',
    paragraphs: [
      'Sin perjuicio de la garantía comercial de un mes prevista en la cláusula 11, el dispositivo físico comercializado por Sensu goza de la garantía legal mínima de doce meses que establece el artículo 77 de la Ley Federal de Protección al Consumidor (LFPC), contada a partir de la fecha de entrega al Cliente.Durante dicho plazo, Sensu responderá por defectos de fabricación o vicios ocultos del dispositivo que impidan su uso normal, mediante alguna de las siguientes opciones a elección razonable de Sensu: (a) reparación sin costo; (b) reposición del dispositivo por uno de las mismas características; o (c) devolución del precio pagado por el dispositivo.Esta garantía legal no cubre daños derivados de uso incorrecto, maltrato, modificaciones no autorizadas, exposición a condiciones físicas o ambientales fuera de las especificaciones del fabricante, ni deterioro por uso normal.Para hacer válida esta garantía, el Cliente deberá contactar a Sensu a través de los canales indicados en la cláusula 41, describir el defecto y, en su caso, enviar el dispositivo con flete prepagado por Sensu al domicilio que ésta indique. Sensu asumirá el costo de devolución del dispositivo reparado o repuesto al Cliente.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'c) WhatsApp al número +52 55 4343 0729.La solicitud de cancelación deberá incluir: nombre del Cliente, número de plan o identificador del dispositivo, y motivo de la cancelación. Sensu acusará recibo de la solicitud dentro de los tres días hábiles siguientes.La cancelación surtirá efectos al término del periodo anual contratado y vigente, salvo que aplique la garantía comercial del primer mes prevista en la cláusula 11. La no renovación no requiere justificación y puede manifestarse por los mismos canales o simplemente absteniéndose de renovar al vencimiento del plan.El Cliente reconoce que, durante la tramitación de la solicitud de cancelación, el servicio permanecerá activo y las obligaciones de pago continuarán vigentes conforme al plan contratado.',
    ],
  },
  {
    title: '42. Devolución del dispositivo',
    paragraphs: [
      'Dado que el dispositivo se vende al Cliente como parte del plan anual, éste no está obligado a devolverlo al término de la vigencia ni en caso de no renovación.Únicamente procederá la devolución del dispositivo en los siguientes supuestos: (a) ejercicio de la garantía comercial del primer mes conforme a la cláusula 11; o (b) ejercicio de la garantía legal conforme a la cláusula 40, cuando la resolución elegida implique sustitución o devolución.En los casos en que proceda devolución, Sensu proporcionará al Cliente una guía de envío prepagada para que remita el dispositivo al domicilio que Sensu indique. El dispositivo deberá entregarse en condiciones funcionales, sin daños por uso indebido y, en la medida de lo posible, con su empaque original. Sensu asumirá el costo del flete de retorno.Una vez recibido y validado el dispositivo, Sensu procederá con la resolución correspondiente (reembolso, reposición o reparación) dentro de los quince días hábiles siguientes.',
    ],
  },
  {
    title: '43. Precio garantizado en renovación',
    paragraphs: [
      'Sensu garantiza al Cliente que el precio del plan anual aplicable en la renovación será el mismo precio que pagó en su contratación original, siempre que la renovación se realice dentro de los treinta días naturales posteriores al vencimiento del plan vigente y que no haya habido una modificación de plan o cambio de modalidad solicitado por el Cliente.En caso de que el Cliente desee renovar con un plan diferente o transcurra el plazo anterior sin renovación, se aplicará el precio vigente al momento de la nueva contratación, el cual podrá diferir del precio original.Esta garantía de precio aplica exclusivamente al servicio de monitoreo y call center. Los costos asociados a servicios de terceros o asistencias adicionales contratadas por separado se regirán por las condiciones vigentes del proveedor correspondiente.',
    ],
  },
  {
    title: '44. Cambio de usuario asociado al dispositivo',
    paragraphs: [
      'El cambio de Usuario asociado al dispositivo únicamente podrá realizarse al momento de la renovación anual del plan, como parte del proceso de actualización de datos que Sensu habilita en dicho momento a través de la plataforma Sensu. No se permitirán cambios de Usuario durante la vigencia del plan activo.Para efectuar el cambio de Usuario en la renovación, el Cliente deberá acceder a la plataforma Sensu e ingresar la información actualizada del nuevo Usuario, cumpliendo con las siguientes condiciones:',
      ...
      'c) el Cliente declare que cuenta con facultades suficientes para proporcionar la información del nuevo Usuario, especialmente si éste es menor de edad, adulto mayor o persona en situación de vulnerabilidad.El cambio de Usuario no implica reinicio del plazo de garantía legal del dispositivo. El Cliente es responsable de actualizar los contactos de emergencia y demás información operativa del nuevo Usuario al momento de efectuar el cambio.El Cliente asume plena responsabilidad por la información proporcionada respecto del nuevo Usuario y por cualquier consecuencia derivada de datos inexactos, desactualizados o proporcionados sin autorización.',
    ],
  },
  {
    title: '45. Pérdida, robo o daño del dispositivo',
    paragraphs: [
      'En caso de pérdida, robo o daño irreparable del dispositivo, el Cliente deberá notificarlo a Sensu de manera inmediata a través de los canales indicados en la cláusula 41.Una vez recibida la notificación, Sensu podrá proceder a la desactivación remota del dispositivo reportado, a fin de evitar el uso no autorizado de las funciones de geolocalización y comunicación asociadas.La pérdida, robo o daño no autorizado del dispositivo no generará obligación de reposición gratuita a cargo de Sensu, salvo que dicha situación esté cubierta por la garantía legal conforme a la cláusula 40. En caso de que el Cliente desee continuar con el servicio, podrá adquirir un dispositivo de reposición al precio vigente que Sensu determine para tal efecto.Mientras no se notifique la pérdida o robo, el Cliente será responsable de cualquier evento, alerta o activación generada por el dispositivo, así como de las consecuencias derivadas del uso no autorizado por terceros.',
    ],
  },
  {
    title: '46. Aviso de Privacidad',
    paragraphs: [
      'El tratamiento de datos personales por parte de Sensu se rige por su Aviso de Privacidad Integral, elaborado conforme a la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP) y su Reglamento.El Aviso de Privacidad se encuentra disponible en el sitio web oficial de Sensu (www.sensu.com.mx) y en la plataforma Sensu. En caso de no haber sido publicado aún al momento de la contratación, Sensu lo pondrá a disposición del Cliente a través del correo atencion@sensu.com.mx, a más tardar al momento de la activación del servicio.El Cliente tiene derecho a ejercer sus derechos ARCO (Acceso, Rectificación, Cancelación y Oposición) mediante solicitud enviada a atencion@sensu.com.mx, adjuntando copia de identificación oficial. Sensu dará respuesta dentro del plazo legal aplicable.La aceptación de estos Términos y Condiciones implica el consentimiento del Cliente para el tratamiento de sus datos personales y los del Usuario conforme al Aviso de Privacidad vigente.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'e) en caso de terminación de la relación laboral o contractual entre la Empresa y el trabajador titular, la Empresa deberá notificarlo a Sensu para proceder con la actualización o cancelación del servicio asociado a dicho Usuario y, en su caso, a los familiares vinculados al mismo.Las condiciones económicas y operativas aplicables a contratos empresariales podrán ser objeto de un contrato marco específico celebrado por separado entre Sensu y la Empresa, el cual prevalecerá sobre estos Términos y Condiciones en lo que expresamente regule.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'e) todas las demás disposiciones de estos Términos y Condiciones aplican a los dispositivos satelitales en lo que no sea incompatible con las características técnicas descritas en esta cláusula.Las características, disponibilidad y condiciones comerciales de los dispositivos con conectividad satelital estarán sujetas a la información específica proporcionada por Sensu al momento de su lanzamiento comercial.',
    ],
  },
  {
    title: '50. Servicios de asistencias a través de proveedor tercero',
    paragraphs: [
      'Determinados planes de Sensu incluyen servicios de multiasistencias prestados por un proveedor tercero especializado. Dichos servicios son coordinados por Sensu como intermediario y ejecutados materialmente por dicho proveedor a través de su Central de Atención Telefónica, disponible las 24 horas del día los 365 días del año. El Cliente reconoce que estos servicios son prestados por un tercero independiente y que su disponibilidad, alcance y condiciones se rigen por las siguientes disposiciones.',
      '50.1 Programa de asistencias y beneficios',
      'Dependiendo del plan contratado, el Cliente podrá tener acceso al programa de asistencias y beneficios integrado por los siguientes módulos, con la cobertura y condiciones que se indican:',
      'A) Asistencia de Salud. Incluye:   — Ambulancia terrestre por emergencia: 1 evento al año, sin costo hasta MXN $2,500.00 por evento o 20 km dentro de la localidad, cobertura nacional al hospital más cercano y conveniente. El envío requiere valoración previa por el médico de cabina del proveedor y aplica únicamente en localidades donde se cuente con servicio de ambulancia; no aplica en caso de accidente en carreteras federales o estatales.   — Médico general a domicilio: 1 evento al año, cobertura hasta $800.00 pesos, sujeto a la valoración previa del médico de cabina y a la disponibilidad de la zona; en caso de no contar con médico disponible, se ofrecerá videoconsulta. No incluye el costo de medicamentos, consultas con especialistas ni atención por COVID-19.   — Plan Médico (red de servicios): acceso a una red de médicos generales y especialistas que ofrecen consultas a costos preferentes desde $300.00 MXN, pagaderos directamente por el Usuario al prestador correspondiente.   — Telemedicina: consultas ilimitadas de medicina familiar (24 horas, 7 días a la semana), así como nutrición, psicología y pediatría (lunes a viernes de 9:00 a 17:00 horas), con envío de receta electrónica cuando el médico lo considere necesario.   — Orientación médica telefónica, orientación psicológica y tanatológica telefónica (una sesión sin costo al año, sesiones adicionales a costo preferente) y orientación nutricional telefónica, conforme a los horarios de atención de cada servicio. Ninguna de estas orientaciones incluye diagnóstico, receta ni costo de medicamentos.   — Check up médico: 1 servicio al año para el titular, con cobertura nacional sujeta a la red de laboratorios del proveedor.   — Biometría facial: herramienta preventiva e informativa de análisis digital de salud, con eventos ilimitados; no sustituye la valoración médica profesional ni emite diagnósticos.',
      'B) Asistencia Vida Diaria. Incluye:   — Plomería, electricidad, vidriería y cerrajería: 2 eventos al año en combinación, hasta $600.00 MXN por evento, no acumulables. Aplica únicamente a inmuebles habitacionales propiedad del titular; el excedente sobre dicho monto será cubierto directamente por el Usuario al proveedor del servicio.',
      'C) Asistencia Mascotas. Incluye:   — Orientación veterinaria telefónica ilimitada, disponible las 24 horas del día los 365 días del año (salud preventiva y reproductiva, nutrición, educación y conducta, emergencias).   — Plan de vacunación y programa de desparasitación.   — Una consulta de valoración sin costo al año (perro o gato) con médicos veterinarios de la red nacional del proveedor, así como acceso a procedimientos veterinarios a costos preferentes.   — Apoyo y orientación en caso de pérdida de mascota. Quedan excluidos de esta cobertura los procedimientos quirúrgicos y la atención médica veterinaria especializada.',
      'D) Servicios de Vida Diaria. Incluye:   — Acceso a una plataforma de aprendizaje digital con contenidos educativos y de desarrollo personal y profesional, sin evaluaciones.   — Acceso a una red de descuentos digital con comercios afiliados a nivel nacional en distintos giros.',
      'El alcance, los límites, las exclusiones y las condiciones específicas de cada módulo se sujetan a los términos y condiciones establecidos por el proveedor de asistencias vigente en cada momento, mismos que Sensu pondrá a disposición del Cliente. La disponibilidad de uno o varios de estos módulos dependerá del plan específico contratado por el Cliente.',
      '50.2 Solicitud del servicio de asistencias',
      'Para acceder a los servicios de asistencias, el Usuario podrá activar la solicitud a través de cualquiera de los siguientes medios:',
      ...
      'b) Plataforma Sensu o aplicación móvil. Mediante la funcionalidad de solicitud de asistencia disponible en la plataforma Sensu o en la aplicación móvil, según las opciones habilitadas en el plan contratado.Una vez recibida la solicitud por cualquiera de los medios anteriores, el call center de Sensu validará la vigencia de la afiliación del Usuario en la base de datos activa del plan y, en coordinación con el proveedor de asistencias, gestionará la atención correspondiente conforme al módulo solicitado y a las condiciones del programa contratado.Sensu proporcionará la información del Usuario al proveedor de asistencias conforme a los procesos operativos acordados entre las partes, a fin de garantizar una atención eficiente y personalizada.',
      ...
      'c) Las consultas médicas, psicológicas y nutricionales se realizan exclusivamente por llamada telefónica o videollamada, conforme a los horarios de atención de cada servicio. No se brindan por mensajes de texto, WhatsApp ni correo electrónico, ni incluyen el costo de medicamentos ni el envío de especialistas a domicilio.',
      'd) El Usuario es responsable de la veracidad y exactitud de la información clínica y personal que proporcione al especialista del proveedor. El proveedor no será responsable por omisiones o inexactitudes del Usuario.',
      'e) Cualquier servicio adicional a los incluidos en el programa contratado será negociado y contratado directamente entre el Usuario y los prestadores de la red del proveedor, sin responsabilidad de pago por parte de Sensu ni del proveedor de asistencias.',
      'f) El proveedor de asistencias no será responsable de los servicios coordinados con prestadores ajenos a su red.',
      'g) Las asistencias no estarán disponibles en los siguientes supuestos: (i) el Usuario no se encuentre en la base de datos activa por causas atribuibles a Sensu o al Cliente; (ii) el Usuario haya contratado el servicio de asistencias por cuenta propia directamente con el proveedor; (iii) exista atraso en el pago del plan que active la suspensión del servicio; (iv) se trate de servicios o supuestos expresamente excluidos conforme al alcance de cada módulo descrito en la cláusula 50.1.',
      'h) El envío de ambulancia está sujeto a valoración previa por el médico de cabina del proveedor, quien determinará si el caso constituye una emergencia conforme a los criterios internos del proveedor. No incluye traslados por COVID-19 ni situaciones que no constituyan una emergencia o urgencia médica, y únicamente aplica en las localidades donde se cuente con servicio de ambulancia disponible.',
      '50.4 Responsabilidad sobre las asistencias',
      'Los servicios de asistencias descritos en esta cláusula son prestados por un tercero independiente. Sensu actúa exclusivamente como intermediario de coordinación y canalización. En consecuencia, y conforme a lo previsto en la cláusula 18 de estos Términos:',
